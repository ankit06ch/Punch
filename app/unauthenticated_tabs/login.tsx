...
import { View, TextInput, TouchableOpacity, ActivityIndicator, Image, StyleSheet, Platform, ScrollView } from 'react-native';
...
export default function LoginScreen() {
  ...
  return (
    <View style={loginStyles.container}>
      <ScrollView contentContainerStyle={loginStyles.content} showsVerticalScrollIndicator={false}>
